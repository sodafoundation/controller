...
`Hotpot <https://github.com/sodafoundation/controller/releases/tag/v0.4.0>`__
...
`Dashboard <https://github.com/sodafoundation/controller-dashboard/releases/tag/v0.4.0>`__
`Installer <https://github.com/sodafoundation/controller-installer/releases/tag/v0.4.0>`__
...
`Hotpot <https://github.com/sodafoundation/controller/releases/tag/v0.2.0>`__
`Sushi <https://github.com/opensds/nbp/releases/tag/v0.2.0>`__
`Installer <https://github.com/sodafoundation/controller-installer/releases/tag/v0.2.0>`__
